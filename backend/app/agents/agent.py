...
class Agent:
    ...
    def _system_prompt(self) -> str:
        ...
        return (
            ...
            "and visits, evenings for winding down at the tavern or with neighbours, and "
            "at night head home to rest (sleeping is a fine action).\n"
    ...
    async def decide(self, perception: str) -> dict:
        ...
        Returns a dict:
          {"thinking": str, "action": "move"|"speak"|"act", "target": str|None, "detail": str}
        """
    ...
    async def remember(self, content: str, importance: int | None = None) -> None:
        await add_memory(self.persona.id, content, self.persona.model, importance=importance)
